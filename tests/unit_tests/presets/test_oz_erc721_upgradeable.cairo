//? AFTER GIVING IT SOME THOUGHTS, I DONT THINK THAT THESE TESTS ARE NECESSERY
//? SINCE I HAVE IMPLEMENTED EACH ONE OF THEM IN TICKETS HANDLER CONTRACT TESTS.
//! (BUT ITS USEFUL TO HAVE AN EXAMPLE OF TESTS IMPLEMENTED BY OPENZEPPELIN)
